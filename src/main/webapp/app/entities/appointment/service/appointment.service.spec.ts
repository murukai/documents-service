...
describe('Service Tests', () => {
  describe('Appointment Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        id: 0,
        dateOfAppointment: currentDate,
        available: false,
        appointmentType: AppointmentType.ORDINARY,
        maxAppointments: 0,
      };
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dateOfAppointment: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
      ...
      describe('addAppointmentToCollectionIfMissing', () => {
        ...
        it('should add only unique Appointment to an array', () => {
          const appointmentArray: IAppointment[] = [{ id: 123 }, { id: 456 }, { id: 16250 }];
