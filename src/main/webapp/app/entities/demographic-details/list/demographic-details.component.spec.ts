...
describe('Component Tests', () => {
  describe('DemographicDetails Management Component', () => {
    let comp: DemographicDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DemographicDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.demographicDetails?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
